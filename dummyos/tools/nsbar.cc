...
// ------------------------------------------------------------------------------------------------
//
// nsbar est un programme, destiné aux développeurs, permettant de:
// * décompresser, mais pas déchiffrer si besoin est, les boot2 et diags pour les calculatrices de la famille Nspire (fichiers "boot2.img" extraits des mises à jour de l'OS de TI);
// * compresser des données arbitraires en utilisant le même algorithme que celui utilisé par TI pour le boot2.
//
// Il existe d'autres façons d'obtenir la forme décompressée du boot2 ou diags, par exemple nspire_emu / ncubate_emu. nsbar est plus pratique... si on réussit, d'une façon ou d'une autre, à reconstruire la version complète. Regardez attentivement le code source du programme.
//
// ------------------------------------------------------------------------------------------------
//
