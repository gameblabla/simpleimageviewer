/*
 * If EXECUTE_APP is defined then you can use it
 * to gut another application to it.
 * For example, command-line only emulator.
 * If EXECUTE_APP is defined, then you can't delete
